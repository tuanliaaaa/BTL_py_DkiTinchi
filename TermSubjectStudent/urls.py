...
from .termSubjectStudentViews import  TermStudentSign,GetTermSubjectStudentNow,TermSubjectStudentBysubjectCode,GetTermSubjectStudentNear,SubjectByTermNear,SubjectByTermNow  
urlpatterns = [
